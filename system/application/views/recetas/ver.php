...
<img src="http://www.isadorabeans.com/files/recetas/<?=$receta[0]->imagen?>" style="display:none">
<img src="http://www.isadorabeans.com/images/recetas/header-recipe.jpg" width="1100" height="160" id="header-print" style="display:none" />
    ...
    <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></li>
                             ...
                             <div id="fb-root"></div>
								<script>(function(d, s, id) {
                                  ...
                                  js.src = "//connect.facebook.net/<?php echo ($this->lang->line('subfijo')=='eng'?'en_US':'es_LA'); ?>/all.js#xfbml=1&appId=44899549644";
