...
<meta property="og:image" content="http://isadorabeans.com/images/isadora.png"/>
...
<div class="wrapp">
	...
	<div class="header">
      ...
      <ul class="menuBox<?php echo $this->lang->line('subfijo');?>">
            ...
            <li class="<? if($this->uri->segment(1)!="promociones"){?>promociones<? }else{?>promocionesSelected<? }?> abrirpromocion_<?php echo $this->lang->line('db'); ?>"><a href="promociones"></a></li>
