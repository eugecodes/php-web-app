...
/*$db['default']['hostname'] = "internal-db.s150241.gridserver.com";
$db['default']['username'] = "db150241";
$db['default']['password'] = "P1X3L1T0!";
$db['default']['database'] = "db150241_isadora";*/
$db['default']['hostname'] = "localhost";
$db['default']['username'] = "root";
$db['default']['password'] = "";
$db['default']['database'] = "isadora";
...
$conn = Doctrine_Manager::connection($db['default']['dsn'], $db['default']['database']);
